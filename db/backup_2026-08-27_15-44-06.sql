...
-- --------------------------------------------------------
-- Table structure for `expired_products`
-- --------------------------------------------------------
...
INSERT INTO `inventory_audit` (`id`, `batch_id`, `product_id`, `action`, `previous_quantity`, `new_quantity`, `previous_kg`, `new_kg`, `seller_store`, `purchase_price`, `notes`, `created_at`) VALUES ('2', '2', '2', 'restock', '0', '100', '0.00', '0.00', 'Lee Plaza', '500.00', 'Initial product creation', '2026-08-27 14:40:38');
INSERT INTO `inventory_audit` (`id`, `batch_id`, `product_id`, `action`, `previous_quantity`, `new_quantity`, `previous_kg`, `new_kg`, `seller_store`, `purchase_price`, `notes`, `created_at`) VALUES ('3', '3', '2', 'restock', '0', '150', '0.00', '0.00', '', '750.00', 'New stock arrival', '2026-08-27 14:49:06');
...
INSERT INTO `product_batches` (`id`, `product_id`, `code`, `name`, `category`, `brand`, `seller_store`, `purchase_price`, `price`, `quantity`, `kg`, `measurement_type`, `purchase_date`, `expiry_date`, `batch_date`, `status`, `image_path`) VALUES ('2', '2', 'P1', 'Coke', 'Drinks', 'Coca Cola', 'Lee Plaza', '500.00', '15.00', '100', '0.00', 'pieces', '2026-08-24', '2028-11-30', '2026-08-27 14:40:37', 'active', 'uploads/prod_6a8fdbe5d75e87.04210523.jpeg');
INSERT INTO `product_batches` (`id`, `product_id`, `code`, `name`, `category`, `brand`, `seller_store`, `purchase_price`, `price`, `quantity`, `kg`, `measurement_type`, `purchase_date`, `expiry_date`, `batch_date`, `status`, `image_path`) VALUES ('3', '2', 'P1', 'Coke', 'Drinks', 'Coca Cola', '', '750.00', '15.00', '150', '0.00', 'pieces', '2026-08-27', '2029-02-13', '2026-08-27 14:49:06', 'active', 'uploads/prod_6a8fdbe5d75e87.04210523.jpeg');
...
INSERT INTO `products` (`id`, `code`, `name`, `category`, `price`, `brand`, `seller_store`, `expiry_date`, `purchase_date`, `pieces`, `kg`, `measurement_type`, `purchase_price`, `image_path`, `date_added`) VALUES ('2', 'P1', 'Coke', 'Drinks', '15.00', 'Coca Cola', 'Lee Plaza', '2028-11-30', '2026-08-24', '250', '0.00', 'pieces', '500.00', 'uploads/prod_6a8fdbe5d75e87.04210523.jpeg', '2026-08-27 14:40:37');
...
-- --------------------------------------------------------
-- Table structure for `restock_requests`
-- --------------------------------------------------------
...
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('156', 'enable_custom_product', '1', 'text', NULL, '2026-08-27 15:36:59', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('157', 'custom_product_label', '➕ Add Custom Product', 'text', NULL, '2026-08-27 15:29:14', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('173', 'enable_bread_type', '0', 'text', NULL, '2026-08-27 15:43:03', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('190', 'custom_name_label', 'Custom Name', 'text', NULL, '2026-08-27 15:40:31', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('191', 'bread_type_label', 'Others', 'text', NULL, '2026-08-27 15:40:31', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('192', 'price_label', 'Price', 'text', NULL, '2026-08-27 15:40:31', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('193', 'qty_label', 'Qty', 'text', NULL, '2026-08-27 15:40:31', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('194', 'unit_label', 'Unit', 'text', NULL, '2026-08-27 15:40:31', NULL);
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `updated_at`, `updated_by`) VALUES ('195', 'add_button_label', 'Add 🛒', 'text', NULL, '2026-08-27 15:40:31', NULL);
